...
use App\Http\Controllers\UserDependenceController;
use App\Http\Controllers\InstrumentDependenceController;
...
Route::group(['middleware'=> ['auth', 'verified']], function () {
    Route::group(['middleware'=>['has.role:Administrador']], function () {
        ...
        Route::resource('/api/web/userDependence', UserDependenceController::class);
        Route::resource('/api/web/instrumentDependence', InstrumentDependenceController::class);
